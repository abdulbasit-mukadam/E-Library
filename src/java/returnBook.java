...
public class returnBook extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Return Book | LMS</title>");
            ...
            try {
                ...
                ResultSet rs = st.executeQuery("select count(*) from borrow where ID =" + ID + "");
                    ...
                    stt.executeUpdate("update borrow set DATERETURNED = '" + dateR + "' where ISBN = " + ISBN + " and ID = " + ID + "");
                }
                out.println("<h2>Book successfully returned!</h2>");               
