...
public class AddBook extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Book Added! | LMS</title>");
            ...
            try {
                ...
                st.executeUpdate("insert into ABDULBASIT.BOOKS values (" + ISBN + ", '" + title + "', '" + author + "', '" + category + "', " + copies + ")");
                out.println("<h2>Book successfully added!</h2>");
                out.println("Go back to <a href=\"adminHome.html\">Homepage</a>");
                conn.close();
