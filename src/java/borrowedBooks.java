...
public class borrowedBooks extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Borrowed Books</title>");   
            ...
            try {
                ...
                out.println("<tr><th>ISBN</th><th>ID</th><th>Date Issued</th><th>Date Due</th><th>Date Returned</th><tr>");
                while (rs.next()) {
                    int ISBN = rs.getInt("ISBN");
                    String title = rs.getString("ID");
                    String author = rs.getString("DateIssue");
                    String category = rs.getString("DateDue");
                    String copy = rs.getString("DateReturned");
